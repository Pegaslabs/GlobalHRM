...
SocialShare.facebook = function(url) {
	...
	window.open(url, "Share on Facebook", "width=" + w + ",height=" + h
			+ ",left=" + left + ",top=" + top);
	return false;
...
SocialShare.google = function(url) {
	...
	window.open(url, "Share on Google", "width=" + w + ",height=" + h
			+ ",left=" + left + ",top=" + top);
	return false;
...
SocialShare.linkedin = function(url) {
	...
	window.open(url, "Share on Linked in", "width=" + w + ",height=" + h
			+ ",left=" + left + ",top=" + top);
	return false;
...
SocialShare.twitter = function(url, msg) {
	window
			.open(
					'http://twitter.com/share?text=' + escape(msg) + '&url='
							+ escape(url),
					'popup',
